...
{
    public class ConsumeLayoutGroupPresenter : LayoutGroupPresenter
    {
        public ConsumeLayoutGroupPresenter(ActiveView view, Inventory model, Dispatcher dispatcher) : base(view, model, dispatcher)
        {
