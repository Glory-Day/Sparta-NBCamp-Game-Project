...
{
    public abstract class TextPresenter : Presenter<TextView, IModel>, ISubscriber
    {
        private Dispatcher _dispatcher;
        public TextPresenter(TextView view, IModel model, Dispatcher dispatcher) : base(view, model)
        {
